                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-md-10 d-flex align-items-center">
                        <div class="services-wrap rounded-right w-100">
                            ...
                            <p class="text-center mt-5"><a href="/car" class="btn text-center mx-auto m-auto ml-auto btn-primary py-3 px-4">Reserve Your Perfect
                                    Car</a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="car-wrap rounded ftco-animate">
                            ...
                            <div class="text">
                                ...
                                <p class="d-flex mb-0 d-block"><a href="/car" class="btn btn-primary py-2 mr-1">Book now</a> <a href="#" class="btn btn-secondary py-2 ml-1">Details</a></p>
                            </div>
                        </div>
                    </div>
                </div>
